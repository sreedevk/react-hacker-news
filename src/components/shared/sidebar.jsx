              ...
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">
                    Jobs
                    <img className="card-img-top float-right" src={require("../../images/jobs.png")} alt="Card image cap" />
                  </h5>
            ...
            <div className="col-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">
                    News
                    <img className="card-img-top float-right" src={require("../../images/news-icon.png")} alt="Card image cap" />
                  </h5>
                  <p className="card-text">
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-body">
                ...
                <img className="card-img-top hackernews-intro-img float-left m-3" src={require("../../images/hacker-news-logo.png")} alt="Card image cap" />
